  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <h1>Transfer Funds From Pool To Pool Test</h1>
        <br />

        <span style={{ color: "orange" }}>
          Only pool admin can send money from pool to pool
        </span>
        <br />
        <br />
        <div>
        ...
        >
          Transfer Fund From this pool to this
        </a>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <p>
            balanceOfpoolOfBDAndPartnership{" "}
            <span style={{ color: "orange" }}>
              {" "}
          ...
          <p>
            balanceOfpoolOfpoolOfMarketing{" "}
            <span style={{ color: "orange" }}>
              {" "}
